                ...
                <form className={`form`} onSubmit={handleSubmit}>
                    ...
                    <div>
                        <input type="password" name="password" id="password" placeholder="Пароль" minLength="2" maxLength="30"
                            className="form__input form__input_type-black" required  value={password} onChange={(e) => setPassword(e.target.value)}/>
                        <span className="form__input-error form__title-error"></span>
                    </div>

                    <button type="submit" className="form__submit sign__button">Зарегистрироваться</button>
                </form>
            </div>
        </div>
    );
